window.__EVERNOTE_I18N__ = {
 "generatedOn": "2017-Jun-01 11:37 PDT",
 ...
 "CheckoutAction.refund.detail": "Direct credit card payments can only be refunded within 30 days of purchase. Direct debit and SEPA payments can be refunded within 8 weeks of debit from your bank account. If Evernote issues a full refund of the amount we received, your bank may not credit you for the full amount you paid. Your bank may not fully refund foreign transaction fees, or the exchange rate may have changed between the date of payment and the date of refund.",
 ...
 "GnomeChoice.ChoicePageComponent.manage.choose.negative": "Remove devices",
 ...
 "GnomeChoice.ManageDevicesPageComponent.header.remove": "Remove devices",
 ...
 "GnomeChoice.ConfirmRevokePageComponent.header.remove": "Remove {{ N_PLURAL:this device|these {{ N }} devices }}?",
 ...
 "GnomeChoice.ConfirmRevokePageComponent.description.onlyUse.one": "You will only be able to use Evernote on {{ BOLD_START }}{{ DEVICE_TYPE }}{{ BOLD_END }} ({{ DEVICE_NAME }}). You will need to sign back in to use Evernote on a removed device.",
 "GnomeChoice.ConfirmRevokePageComponent.description.onlyUse.two": "You will only be able to use Evernote on {{ BOLD_START }}{{ DEVICE_TYPE_1 }}{{ BOLD_END }} ({{ DEVICE_NAME_1 }}) and {{ BOLD_START }}{{ DEVICE_TYPE_2 }}{{ BOLD_END }} ({{ DEVICE_NAME_2 }}). You will need to sign back in to use Evernote on a removed device.",
 ...
 "MasTiersBanner.message": "Your subscription will renew automatically but you can cancel at any time.",
 ...
 "WelcomeNoteUtil.welcomeNotebookName.life": "Life",
 "WelcomeNoteUtil.welcomeNotebookName.play": "Play",
 "WelcomeNoteUtil.welcomeNotebookName.work": "Work",
 "WelcomeNoteUtil.welcomeNotebookName.documents": "Documents",
 "WelcomeNoteUtil.welcomeNotebookName.notes": "Notes",
 "WelcomeNoteUtil.welcomeNotebookName.webClippings": "Web Clippings",
 ...
 "ROAuthAction.perm.16384": "Login via SSO",
 "ROAuthAction.perm.16384.sandbox": "Login via SSO",
 ...
 "BusinessCheckoutAction.FreeTrial.PitchPanel.faq.2.answer": "If you have an active Evernote Business account at the end of {{ 0 }} days, you will be billed for all seats in your business using the method you selected when signing up for your trial. With credit card billing, your card will automatically be charged; with invoicing, you will receive your first invoice.",
 ...
 "JoinBusinessAction.createAccount.header": "Create business account",
 ...
 "JoinBusinessAction.label.password": "New password",
 "JoinBusinessAction.terms": "By clicking 'Create business account', you agree to the {{ 0 }} and {{ 1 }}.",
 ...
 "JoinBusinessLoginAction.header": "First, sign in to your current account",
 "JoinBusinessLoginAction.subheader": "We need to confirm that you are you.",
 ...
 "JoinBusinessAction.existingUserNewEmailInputPage.text": "Great! Let\u2019s change the email address on your current account.",
 "JoinBusinessAction.existingUserNewEmailInputPage.subtext": "Your current account will be linked to the new email you enter now. This will make <b>{{ 0 }}</b> available for your new business account.",
 "JoinBusinessAction.existingUserNewEmailInputPage.label.currentEmail": "Current Email Address",
 "JoinBusinessAction.existingUserNewEmailInputPage.label.newEmail": "Different email address (your password won\u2019t change)",
 "JoinBusinessAction.existingUserNewEmailInputPage.reason.header": "Why do I have to use a different email address?",
 "JoinBusinessAction.existingUserNewEmailInputPage.reason.body": "Using a different email address keeps the notes you already have separate from your new business account. You can import notebooks into your business account later, and your company will own them.",
 "JoinBusinessAction.existingUserNewEmailInputPage.submit": "Update my email",
 ...
 "ManageNotebooksAction.action.showNotebook.numNotes": "({{ N }} notes)",
 ...
 "ManageNotebooksAction.action.delete.dialog.body": "Are you sure you want to delete {{ NB_PLURAL:{{ NAME }}|{{ NB }} notebooks }}? The {{ N_PLURAL:{{ N }} note|{{ N }} notes }} contained in {{ NB_PLURAL:this notebook|these notebooks }} will also be deleted.",
 ...
 "SharedNote.presentationMode.bannerSwitchToPresentation": "New! View this note as a presentation for easy reading, {{ DARKSTART }}with optional dark mode.{{ DARKEND }}",
 "SharedNote.presentationMode.buttonViewPresentation": "View presentation",
 "SharedNote.presentationMode.modalSwitchToPresentation": "Switch to a larger view for easy reading, with optional dark mode.",
 "SharedNote.presentationMode.notNow": "Not now",
 ...
 "ManageScimAction.subtitle": "SCIM",
 "ManageScimAction.header": "Evernote business SCIM",
 "ManageScimAction.getStarted.header": "Get Started",
 "ManageScimAction.getStarted.1": "Copy your Business token",
 "ManageScimAction.message.finish": "To complete the Evernote Business SCIM integration, you will need to paste this token into your identity provider directly during the installation process:",
 "ManageScimAction.button.code": "Copy token",
 "ManageScimAction.message.code.copied": "Copied!",
 "ManageScimAction.button.create": "Create a SCIM token",
 "ManageScimAction.button.revoke": "Revoke the SCIM token",
 "ManageScimAction.expire.text": "SCIM token is valid until",
 "ManageScimAction.error.findToken": "An error occurred while finding a SCIM token.",
 "ManageScimAction.error.createToken": "An error occurred while creating a SCIM token.",
 "ManageScimAction.error.revokeToken": "An error occurred while revoking a SCIM token.",
 ...
 "Focus.businessFirstLaunchDialogView.welcomeHeader": "Welcome to your business account",
 "Focus.businessFirstLaunchDialogView.existingUser.text": "Use {{ 0 }} to sign in to this account, and {{ 1 }} for your other account.",
 "Focus.businessFirstLaunchDialogView.newUser.text": "You\u2019ve successfully created your business account! Start collaborating with your team.",
